...
export const integrantes = [
  {
    ...
    educacion: [
      ...
      { anio: '2022', titulo: 'Magister en Ingeniería en Calidad', detalle: '' },
      { anio: '2020', titulo: 'Lic. en Prevención Laboral', detalle: '' }
    ]
  ...
  },
  {
    ...
    educacion: [
      { anio: '2025', titulo: 'Tecnicatura Universitaria en Programación (UTN)', detalle: 'En curso' },
      { anio: '2023', titulo: 'QA Automation', detalle: 'Frameworks de testing, automatización' }
    ]
  ...
  },
  {
    ...
    educacion: [
      { anio: '2025', titulo: 'Tecnicatura Universitaria en Programación (UTN)', detalle: 'En curso' },
      { anio: '2018', titulo: 'Profesorado en Biología', detalle: '' }
    ]
  ...
  },
  {
    ...
    educacion: [
      { anio: '2025', titulo: 'Tecnicatura Universitaria en Programación (UTN)', detalle: 'En curso' },
      { anio: '2024', titulo: 'QA Manual', detalle: 'Pruebas funcionales, reporte de bugs' },
      { anio: '2011', titulo: 'Licenciatura / Enología', detalle: '' }
    ]
  ...
  },
  {
    ...
    educacion: [
      { anio: '2025', titulo: 'Tecnicatura Universitaria en Programación (UTN)', detalle: 'En curso' },
      { anio: '2020', titulo: 'Tec. Higiene y Seguridad', detalle: '' }
    ]
  ...
  },
  {
    ...
    educacion: [
      { anio: '2025', titulo: 'Tecnicatura Universitaria en Programación (UTN)', detalle: 'En curso' },
      { anio: '2019', titulo: 'Diseño Gráfico', detalle: '' }
    ]
